...
- **[Инструкция по развертыванию на сервере](DEPLOYMENT.md)** — полная инструкция для production-развёртывания
- **[KODA.md](KODA.md)** — техническая документация для разработчиков
